    ...
    foreach ($objPHPExcel->getWorksheetIterator() as $worksheet) {
        ...
        $i = 0;
            ...
            foreach ($cellIterator as $cell) {
                if ($cell->getValue() == 'YEAR' or $cell->getValue() == 'MES' or $cell->getValue() == 'PAIS' or $cell->getValue() == 'SUBPARTIDA NANDINA' or $cell->getValue() == 'DESCRIPCION NANDINA' or $cell->getValue() == 'PESO - KILOS' or $cell->getValue() == 'FOB - DOLAR' or $cell->getValue() == '% / TOTAL FOB - DOLAR'){
                    continue;
                }else{
        ...
        if (!empty($array[0])) {
                ...
                $sql = "INSERT INTO comercio_export_nandina".
               "(ano,mes,pais,subpartida_nandina,peso,fob)".
               "VALUES ".
               "($ano_int,$mes_int,$pais_int,$subpartida_nandina_int,$peso_float,$fob_float);";
