...
urlpatterns = patterns('',
    ...
    url(r'^definicion-indicador/(?P<cat_id>\d+)/(?P<subcat_id>\d+)/(?P<ind_id>\d+)/$', 'indicators.views.indicator_def', name='def'),
    ...
    url(r'^valid_desa/', 'indicators.views.valid', name='valid'),
