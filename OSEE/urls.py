...
urlpatterns = patterns('',
    ...
    url(r'^is_login/', 'registers.views.is_login', name='is_login'),
    url(r'^historia/', 'home.views.timeline', name='timeline'),
    url(r'^definicion-indicador/(?P<method_id>\d+)/(?P<cat_id>\d+)/(?P<subcat_id>\d+)/(?P<ind_id>\d+)/$', 'indicators.views.indicator_def', name='def_mix'),
    url(r'^definicion-indicador/', 'indicators.views.indicator_def', name='def'),
    url(r'^calculo-indicador/(?P<method_id>\d+)/(?P<cat_id>\d+)/(?P<subcat_id>\d+)/(?P<ind_id>\d+)/$', 'indicators.views.indicator_calc', name='calc_mix'),
    ...
    url(r'^busqueda/','resources.views.search',name='search'),
    ...
    url(r'^filter_by/', 'indicators.views.filter_by', name='filter_by'),
    ...
    url(r'^eliminar_datos_enemdu/', 'ENEMDU.views.delete_data_enemdu', name='delete_data_enemdu'),
    url(r'^eliminar_datos/', 'ENEMDU.views.eliminar_datos', name='eliminar_datos'),
    url(r'^eliminar_datos_rango/', 'ENEMDU.views.eliminar_datos_rango', name='eliminar_datos_rango'),
    url(r'^eliminar_anio_rango_trim/', 'ENEMDU.views.eliminar_anio_rango_trim', name='eliminar_anio_rango_trim'),
    url(r'^error/', 'ENEMDU.views.error', name='error'),
