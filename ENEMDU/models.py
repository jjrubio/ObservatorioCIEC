...
class Data_from_2003_4(models.Model):
    ...
    anosaprob = models.SmallIntegerField(null=True)
    ...
    ingrl = models.DecimalField(decimal_places=2, max_digits=7, null=True, blank=True)
    rama_act_1 = models.CharField(max_length=75, null=True, blank=True)
    rama_act_2 = models.CharField(max_length=75, null=True, blank=True)
    grupo_ocup_1 = models.CharField(max_length=75, null=True, blank=True)
    ...
    experiencia = models.DecimalField(decimal_places=2, max_digits=5, null=True, blank=True)
    ...
    tamano_hogar = models.DecimalField(decimal_places=2, max_digits=4, null=True, blank=True)
    ...
    categ_ocupa = models.CharField(max_length=75, null=True, blank=True)
    ...
    tipo_deso = models.CharField(max_length=75, null=True, blank=True)
